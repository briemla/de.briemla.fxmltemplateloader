...
public interface ITemplate extends ExistingRoot {
    ...
    <T> T create() throws InstantiationException, IllegalAccessException, IllegalArgumentException,
            InvocationTargetException, LoadException;

    <T> T create(Object controller) throws InstantiationException, IllegalAccessException,
